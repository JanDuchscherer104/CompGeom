use lab01::utils::read_lines_from_file;
...
fn identical_number_of_intersections_for_internal_and_external_computation() {
    ...
    for intersection in internal_intersections.iter() {
        println!(
            "(({}, {}),({}, {})) x (({}, {}), ({},{}))",
            intersection.0.start.x,
            intersection.0.start.y,
            intersection.0.end.x,
            intersection.0.end.y,
            intersection.1.start.x,
            intersection.1.start.y,
            intersection.1.end.x,
            intersection.1.end.y
        );
    }
